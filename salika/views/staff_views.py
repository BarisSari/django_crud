...
class StaffListView(ListView):
    model = Staff
    template_name = "salika/staff_list.html"
    paginate_by = 20
...
class StaffDetailView(DetailView):
    model = Staff
    template_name = "salika/staff_detail.html"
...
class StaffCreateView(CreateView):
    ...
    template_name = "salika/staff_create.html"
    ...
    def get_success_url(self):
        return reverse("salika:staff_detail", args=(self.object.pk,))


class StaffUpdateView(UpdateView):
    model = Staff
    form_class = StaffForm
    # fields = ['staff_id', 'first_name', 'last_name', 'address', 'email', 'store_id', 'active', 'username', 'password', 'last_update', 'picture']
    template_name = "salika/staff_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class StaffDeleteView(DeleteView):
    model = Staff
    template_name = "salika/staff_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "staff"
    ...
    def get_success_url(self):
        return reverse("salika:staff_list")

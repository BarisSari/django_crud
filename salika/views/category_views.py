...
class CategoryListView(ListView):
    model = Category
    template_name = "salika/category_list.html"
    paginate_by = 20
...
class CategoryDetailView(DetailView):
    model = Category
    template_name = "salika/category_detail.html"
...
class CategoryCreateView(CreateView):
    ...
    template_name = "salika/category_create.html"
    ...
    def get_success_url(self):
        return reverse("salika:category_detail", args=(self.object.pk,))
...
class CategoryUpdateView(UpdateView):
    ...
    form_class = CategoryForm
    # fields = ['category_id', 'name', 'last_update']
    template_name = "salika/category_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class CategoryDeleteView(DeleteView):
    model = Category
    template_name = "salika/category_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "category"
    ...
    def get_success_url(self):
        return reverse("salika:category_list")
